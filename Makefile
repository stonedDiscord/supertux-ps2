...
ACLOCAL = ${SHELL} ./missing --run aclocal-1.7
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} ./missing --run tar
AUTOCONF = ${SHELL} ./missing --run autoconf
AUTOHEADER = ${SHELL} ./missing --run autoheader
AUTOMAKE = ${SHELL} ./missing --run automake-1.7
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -pthread
CPP = gcc -E
CPPFLAGS = 
CXX = g++
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -g -O2 -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -pthread -DDATA_PREFIX='"${prefix}/share/supertux"'
CYGPATH_W = echo
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lz -lSDL_image -lSDL_mixer  -L/usr/lib/x86_64-linux-gnu -lSDL -lGL  -lm
LTLIBOBJS = 
